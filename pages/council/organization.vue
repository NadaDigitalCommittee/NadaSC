    ...
    <transition>
      <section class="parliament sentence" v-show="tabnum == 2">
        ...
        <Accordion>
          ...
          <div slot="content">
            <p>
              選挙管理委員会は評議会の下部機関で、中央委員選挙を円滑かつ公正に運営するために設置されます。選挙管理委員会は選挙管理委員から構成され、選挙管理委員長は評議会議長が、選挙管理副委員長は評議会副議長が、各クラスの選挙管理委員は各クラスの首席評議員がそれぞれ兼任します。選挙管理委員会は選挙の執行のための細則の制定や、選挙に関して規則又は細則等違反の疑いのある行為についての違反の有無の認定を行います。
            </p>
          </div>
        </Accordion>
        <Accordion>
