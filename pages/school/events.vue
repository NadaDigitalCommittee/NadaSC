<template>
  <div>
    ...
    <section>
      ...
      <h3>文化祭</h3>
      <p>
        灘校の一大イベントである文化祭は、灘校にて5月2日・3日に開催されます。各部活のブースをはじめとして中庭ステージでの筋肉王やMr.&Ms.コンテスト、視聴覚室や大講堂ステージでの様々なパフォーマンスなど多くの見どころがあります。
      </p>
      <p>
      ...
      <h3>中間考査</h3>
      <p>
        5月の中旬には中間考査があります。5月は文化g祭などもあり、忙しい月になるでしょうが、新学年で最初の中間考査となるので気を引き締めて頑張りましょう。
      </p>
    </section>
    <section>
      <h2>6月 June</h2>
    ...
    <section>
      ...
      <h3>スポーツ大会</h3>
      <p>
        期末考査が終了し、少し休みを挟んだ後のテスト返却日の前日に行われます。高校2年生までの全生徒がサッカー・ドッヂボール等の競技で期末考査で蓄積したストレスを発散します。
      </p>
      <h3>夏休み</h3>
      <p>
