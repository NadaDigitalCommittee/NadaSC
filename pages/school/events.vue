<template>
  <div>
    ...
    <section>
      ...
      <h3>体育祭</h3>
      <p>
        灘校の体育祭は毎年9月下旬に行われます。全体リハーサルは一度しかなく、進行のちぐはぐさは良くも悪くも灘校名物です。中学生が行う400mリレーの理事長杯、高校生が行う1000mリレーの校長杯や相撲などが人気です。また競技だけでなく、複数のチームが描いた垂れ幕にも注目です。2020年度や2021年度は、新型コロナウイルスの影響で規模を縮小して開催されましたが、今までと同様の盛り上がりを見せました。
      </p>
    </section>
    <section>
      <h2>10月 October</h2>
