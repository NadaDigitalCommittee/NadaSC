<template>
  <div>
    ...
    <section>
      ...
      <p>
        また、体育館の地下にはパイプ椅子の倉庫やブラスバンド部の練習場所があります。体育館は土足禁止ですので、授業には体育館シューズを持参するようにしましょう。また、体育館へ行く時に渡る道路は短いですが公道であり、よく車が通るので走らないように注意しましょう。
      </p>
    </section>
    <section>
      <h2>新中庭・スクエア</h2>
    ...
    <section>
      ...
      <p>
        また、年に一度の体育祭もここで行われます。人工芝の劣化を防止するために、水・お茶以外の飲食物の持ち込みは禁止されているので注意しましょう。
      </p>
    </section>
    <section>
      <h2>第２グラウンド</h2>
      ...
      <p>
        校舎とは、歩道橋でつながっています。夕方ごろには灘校生御用達のラーメン屋、しぇからしかの匂いがするでしょう。
      </p>
    </section>
    <section>
      <h2>図書館</h2>
      ...
      <p>
        また、週に１回、図書館から発行される本の新着案内「NANDA
        KANDA」では、生徒や先生のリクエストした新着本などが司書さんの言葉で紹介されており、読書の幅を広げるきっかけとなるでしょう。
      </p>
      <p>
    ...
    <section>
      ...
      <p>
        １階には事務所などがあります。事務所では願書や入試問題などを買うことができます。１階の中央通路は西館側と３号館側に繋がっていますが、事務所に用がない限り通ってはいけません。
      </p>
      <p>
